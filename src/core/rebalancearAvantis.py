...
def calcular_proporciones():
    ...
    activos['comisión_pagada'] = (activos['monto_invertir'] / activos['monto_invertir'].sum()) * (comisionPagada/dolarObservado)
    ...
    totales = ['inversion_total_usd', 'porcentaje_actual', 'monto_invertir', 'comisión_pagada', 'inversión_nueva', 'proporción_nueva', 'proporción_ideal']
